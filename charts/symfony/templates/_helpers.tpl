...
Common labels
*/}}
{{- define "symfony.common.selectorLabels" -}}
app: {{ template "symfony.name" . }}
{{- end }}
...
*/}}
{{- define "symfony.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "symfony.fullname" .) .Values.serviceAccount.name }}
{{- else }}
